...
_sprite = s_enemySegmets_segmentMega;
_segments = irandom_range(5,8);
...
instAchor = instance_create_layer(x,y,"Enemies",o_enemySegments_last_Mega)
...
for (var i=2; i<=_segments-1; i++)
{
	...
	instBody[i].sprite_index = s_enemySegmets_segmentHitBox_Mega;
