...
if (drawText)
{
	...
	draw_text(__view_get( e__VW.XView, 0 )+319,__view_get( e__VW.YView, 0 )+316,string(textToDraw))
	...
	draw_text(__view_get( e__VW.XView, 0 )+320,__view_get( e__VW.YView, 0 )+315,string(textToDraw))
}
