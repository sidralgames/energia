...
inst = instance_nearest(x,y,o_friend)
_segments = 4;
// Create a new rope
rope1 = verletGroupCreateRope(verletSystem1, x, y, cableColor, 1, 4, _segments, 1 ,100, canCollide);
...
instTope = instance_create_layer(x,y,"Shield", o_chargerFriend);
