...
draw_text(__view_get( e__VW.XView, 0 )+70,__view_get( e__VW.YView, 0 )+80, string(levelType))
draw_text(__view_get( e__VW.XView, 0 )+70,__view_get( e__VW.YView, 0 )+100, string(totalFloor))
draw_text(__view_get( e__VW.XView, 0 )+70,__view_get( e__VW.YView, 0 )+120, string(realSteps))
