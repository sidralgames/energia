...
draw_set_font(global.customFont10)
draw_text(__view_get( e__VW.XView, 0 )+640,__view_get( e__VW.YView, 0 )+80, string(levelType))
draw_text(__view_get( e__VW.XView, 0 )+640,__view_get( e__VW.YView, 0 )+90, string(totalFloor))
