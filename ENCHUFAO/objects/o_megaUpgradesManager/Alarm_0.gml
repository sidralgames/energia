...
if (upgradesTotal < 3)
{
	upgradeChosen = ds_map_find_value(global.megaUpgradesList,irandom(global.numberOfMegaUpgrades-1));
		
	if (upgradeChosen.canShowUp == true) && (upgradeChosen.isPicked == false)
	{
		upgradeChosen.isPicked = true;
		upgradeChosen.timesPicked += 1;
		placeholder = instance_nearest(x,y,o_enchufePLACEHOLDERmega);
