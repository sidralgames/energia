...
function DrawLaserPlayer(argument0,argument1)
{
...
if (key_laser) && !(laserActive)
	...
	if (laserActive) 
	{
		...
		draw_circle_colour(x-1+lengthdir_x(argument1,argument0), y+lengthdir_y(argument1, argument0),(height*2)+blueWidht+global.laserWidth,azul, azul, false)
		draw_circle_colour(x-1+lengthdir_x(argument1,argument0), y+lengthdir_y(argument1, argument0),(height*1)+whiteWidht+global.laserWidth,blanco, blanco, false)
	
		draw_set_color(azul);
		draw_line_width(x-1+lengthdir_x(13,_angle), y+lengthdir_y(13, _angle), x+lengthdir_x(argument1,argument0), y+lengthdir_y(argument1, argument0), (height * 3) + blueWidht+global.laserWidth);
		//draw_set_color(rojo);
		//draw_line_width(x-1, y-7*image_yscale, x-1, y-16-long*image_yscale, (height * 3) + 4);
		draw_set_color(blanco);
		draw_line_width( x-1+lengthdir_x(13,_angle), y+lengthdir_y(13, _angle), x+lengthdir_x(argument1,argument0), y+lengthdir_y(argument1, argument0),(height * 1) + whiteWidht+global.laserWidth);
		draw_set_alpha(1)
