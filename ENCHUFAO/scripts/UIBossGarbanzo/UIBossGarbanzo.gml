...
function UIBossGarbanzo()
{
	if (room = Sala_SecondBoss) && instance_exists(o_BossMecha_Inside) && (global.BossGarbanzo_Awaken = true) // && !instance_exists(o_BreachBossBanner)
	{
		...
		draw_text(__view_get( e__VW.XView, 0 )+224,__view_get( e__VW.YView, 0 )+4,string(round(o_BossMecha_Inside.hp)))
		draw_set_color(c_white)
		draw_text(__view_get( e__VW.XView, 0 )+225,__view_get( e__VW.YView, 0 )+3,string(round(o_BossMecha_Inside.hp)))
	}
}