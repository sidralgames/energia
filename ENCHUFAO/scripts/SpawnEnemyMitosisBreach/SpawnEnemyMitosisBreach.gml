...
function SpawnEnemyMitosisBreach()
{
	if instance_exists(o_playerShip)
	{
		for (var i=0; i<1; i++)
		{
			...
			{
				enemy = choose(o_enemyMitosis,o_enemyMitosis,o_enemyMitosis_Son,o_enemyMitosis_Son,o_enemyMitosis_Son,o_enemyMitosis_Son,o_enemyMitosis_Son,o_enemyMitosis_Son,o_enemyMitosis_Son, peta)
			}
			else
			{
				enemy = o_enemyFast;
